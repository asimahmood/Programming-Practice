...
class BST(TreeNode):
	...
	def find_root(self):
		# *** Find the absolute root of th BST to which self belongs. Keep going up until you reach no-parent node.***
		temp = self	
	...
	def set_for_parent(self, new_ref):
		# Disonnect self from parent and attach new_ref to parent in self's place.
